        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfLikes = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseAuthor", x => new { x.AuthorsId, x.CoursesId });
                    table.ForeignKey(
                        name: "FK_CourseAuthor_Authors_AuthorsId",
                        column: x => x.AuthorsId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseAuthor_Courses_CoursesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseAuthor_CoursesId",
                table: "CourseAuthor",
                column: "CoursesId");
