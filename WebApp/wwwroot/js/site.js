document.addEventListener("DOMContentLoaded", () => {
    ...
    btnMenu.addEventListener('click', () => {
        ...
        btnMenu.classList.toggle('menu-display');
        nav.classList.toggle('active')
        showcase.classList.toggle('menu-display');
    })

    window.addEventListener('resize', () => {
        btnMenu.classList.remove('active')
        btnMenu.classList.remove('fixed')
        btnMenu.classList.remove('menu-display');
        showcase.classList.remove('menu-display');
        ...
        document.querySelector('#searchQuery').addEventListener('keyup', function () {
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    document.querySelector('.courses-list').innerHTML = dom.querySelector('.courses-list').innerHTML
